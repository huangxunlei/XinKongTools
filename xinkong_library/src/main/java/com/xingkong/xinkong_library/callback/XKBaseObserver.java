 ...
 * @author hxl
 * @version 1.0.0
 * @since 2017-07-07 11:41
 */
public abstract class XKBaseObserver<T> extends BaseObserver<T> {
    ...
    public XKBaseObserver() {
        this(null, null);
    }

    public XKBaseObserver(BaseImpl base) {
        this(base, null);
    }

    public XKBaseObserver(BaseImpl base, String titleMsg) {
        super(base);
    ...
    protected void onBaseError(Throwable t) {
        ...
        XKToast.showToastSafe(sb.toString());
    }
}
